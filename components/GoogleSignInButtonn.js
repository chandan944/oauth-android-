...
export default function GoogleSignInButtonn() {
...
const signIn = async () => {
  ...
  try {
    ...
    console.log('🔑 ID Token:', result.idToken || result.data?.idToken);
  ...
  // ✅ FIXED: Helper function to safely get user data
  const getUser = () => {
        ...
        <View style={styles.userCard}>
          ...
          <View style={styles.tokenContainer}>
            ...
            <Text style={styles.tokenText}>
              {userInfo.idToken?.substring(0, 50) || 'No token'}...
            </Text>
          </View>
